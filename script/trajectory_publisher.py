...
def publish_footplacements(footplacements, param_name):
    ...
    print('dafa name is ', footplacements)
...
def publish_all(com_trajectory, zmp_trajectory, support_durations, support_indexes, foot_placements, swing_height, com_gain):
    try:
        while not rospy.is_shutdown():
            publish_com_trajectory(trajectory=com_trajectory, param_name='com_trajectory')
            publish_zmp_trajectory(trajectory=zmp_trajectory, param_name='zmp_trajectory')
